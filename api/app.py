...
def get_data():
    ...
    categories = {
        ...
        'socialfi': ['friend-tech',	'theta-token',	'cyberconnect',	'project-galaxy',	'deso',	'xcad-network',	'dmail-network',	'cheelee',	'steem',	'somesing',	'port3-network',	'eesee',	'limewire-token',	'access-protocol',	'xana',	'rally-2',	'hive'],
        'identity': ['civic',	'concordium',	'cyberconnect',	'metadium',	'microvisionchain',	'project-galaxy',	'selfkey',	'syscoin',	'worldcoin-wld']
    }
